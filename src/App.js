...
function App() {
  ...
  /*let [country, setCountry] = useState('') no salta error pero veo que esta demas Manu comentado*/
  ...
  const getCountryCode = (selectedCountry) => {
    /*setCountry(selectedCountry)no salta error pero veo que esta demas Manu comentado*/
